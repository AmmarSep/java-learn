[Home](../../README.md) · [All lessons](../README.md) · [This topic](README.md) · [Previous](../03-values-types/20_Var.md) · [Next](22_Comparisons.md)

**Runnable companion:** [SimpleCalculation](../../examples/00-getting-started/03-simple-calculation/SimpleCalculation.java), [Phase1_Operators](../../examples/01-fundamentals/02-operators/Phase1_Operators.java). See the [runner guide](../../scripts/README.md).
